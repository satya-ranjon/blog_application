...
const Header = () => {
  ...
  return (
    <header className="container px-2 sm:px-8 xl:px-0  mx-auto   flex justify-between py-5 items-center font-opensans ">
      <div>
        <img src={images.logo} alt="logo" className="w-16 h-4" />
      </div>
